...
This lesson is the hands-on half of React. In the previous lesson, [**React Library**](https://github.com/JMRMEDEV/frontend-course/blob/master/lesson-8/README.md), we covered *what* React is, how it compares to Angular and Vue, and where it is used. Here we get into the *how*: the concepts and code you write every day.

> **A note on this lesson.** This one is long because it is where the real work is. It is organized into clearly separated areas (E–I), the same way the live sessions are. You do not have to absorb everything at once, treat it as a reference you can come back to. Wherever the ecosystem has moved on since this material was first written, you will find a **Modern note** callout pointing at the up-to-date way of doing things (this lesson targets **React 19**).
